...
L’atelier RGPD/ PGD, a été animé par Julien Rossi, Cécile Arènes et Océane Valencia.
...
[1. Statut des images](#statut_images)
[2. Travail sur les réseaux](#travail_reseaux)
[3. Enquêtes, droit à l’oubli](#enquetes)
[4. Données sensibles](#donnees_sensibles)
[5. Questions diverses](#questions_diverses)

## 1. Statut des images <a id="statut_images"></a>

Quel est le **statut d'images photographiques prises pendant une enquête **de terrain (pour le documenter et/ou comme donnée intégrante du protocole scientifique) :

a. Quel **droit à l’image** s'applique dans ce cas là, notamment si des personnes sont présentes sur les images ? Doivent-elles signer une décharge et/ou être de trois quart / de dos (donc non identifiable) ?

b. Quels sont les **droits de publication de mes propres images d'enquête** en tant que chercheur dans une revue scientifique par exemple ? Est-ce que le régime varie en fonction du sujet photographié, et/ou du support de diffusion (en ligne, papier, en ligne et papier) ? Les images de personnes identifiables sont des données à caractère personnel.
...
Travailler sur des corpus d'images diffusées sur le Web implique de pouvoir les montrer (publications scientifiques). Il semblerait que cela contrevienne au droit d'auteur. **L'accord de l'auteur d'une image (caricature, photo) suffit-elle pour la publication lorsque celle trouvée transformée par ses circulations (mêmes internet)** **?**
...
## 2. Travail sur les réseaux <a id="travail_reseauxs"></a>
...
## 3. Enquêtes, droit à l'oubli <a id="enquetes"></a>
...
Doit-on **mentionner un certain article de loi (CNIL?) **dans l'introduction d'un questionnaire en ligne? Y-a-t-il d'autres informations obligatoires à indiquer au répondant pour être en conformité?
...
## 4. Données sensibles <a id="donnes_sensibles"></a>
...
Est-ce que nous sommes tenus de **sécuriser **les données sur l’ordinateur ?
...
## 5. Questions diverses <a id="questions_diverses"></a>
...
Existe-t-il des **normes de stockages des données à respecter **pour les entretiens et questionnaires lorsqu'on garantit la confidentialité à l'interviewé/répondant?
