...
Nous avons animé un module pédagogique dans le cadre de la formation portée par la BSU dédiée aux sciences ouvertes. Ce module, intitulé "Modéliser les connaissances en SHS : pourquoi ? comment ? jusqu'où ?" avec le CIDOC-CRM fg, articule une partie méthodologique (le rôle de l'ingénieur·e dans les phases amont des projets de recherche en SHS produisant des données) et une partie plus technique (la prise en main de l'ontologie sémantique CIDOC-CRM[^8]). Sa fréquence est pour l'instant annuelle.
